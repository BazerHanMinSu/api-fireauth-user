...
const _getFetch = (url) => {
  var userAuth = getCookie('userAuth') ? JSON.parse(getCookie('userAuth')) : false;

  var token = userAuth ? userAuth.token : "NOT_HAVE_TOKEN";
  var id    = userAuth ? userAuth.user.id : "NOT_HAVE_ID";
